<template>
	<div class="list-container">
		<ul class="list-header">
			<li class="posting-id">用户ID</li>
			<li class="posting-author">用户昵称</li>
			<li class="posting-info">已加入用户组</li>
			...
			<li>
				<ul class="list-contents">
					...
					<li class="posting-author more-line">
						<p>
							<span class="lines c-gris"><span class="c-carbon">简单了</span></span>
						</p>
					</li>
					<li class="posting-info more-line">
						<p>
							<span class="lines">
								<span class="c-gris">组名：
                                   <span class="c-carbon">用户1、用户2、用户3、用户2、用户3、用户2、用户3、用户2、用户3</span>
								</span>
							</span>
						</p>
					</li>
