<template>
	<div class="list-container">
		<ul class="list-header">
			<li class="header-col01">社区分类</li>
			<li class="header-col02">社区ID</li>
      <li class="header-col02">社区名字</li>
			<li class="header-col03">链接</li>
			...
			<li v-for="(item, index) in paras" style="width:100%" :key="index">
                ...
                <li class="header-col02"></li>
								...
								<li class="header-col04" style="display:flex">
									<span class="pointer" style="flex:0 0 25%" @click="openPop">添加社区</span>
                ...
                <li class="header-col02">{{items.vla}}</li>
								<li class="header-col03">查看</li>
								<li class="header-col04" style="display:flex">
									<span class="pointer" style="flex:0 0 15%" @click="removed">删除</span>
								</li>
							</ul>
