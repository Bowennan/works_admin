...
<script>
    import bannerSearchComp from '@/components/webpage/banner-search-comp'
	import bannerTitleComp from '@/components/webpage/banner-title-comp'
	import bannerListComp from '@/components/webpage/banner-list-comp'
