<template>
	<div class="list-container">
		<ul class="list-header">
			<li class="posting-id">
               <Checkbox v-model="single">试用产品ID/日期</Checkbox>
			</li>
			<li class="posting-author">产品名</li>
			<li class="posting-info">链接</li>
			...
			<li>
				<ul class="list-contents">
					...
					<li class="posting-author more-line">
						<p>
							<span class="lines c-gris"><span class="c-carbon">大疆无人机121</span></span>
						</p>
					</li>
					<li class="posting-info more-line">
						<p>
							<span class="lines">查看</span>
						</p>
					</li>
