	...
	<div class="list-container">
		...
		>
				<div class="pop-wrapper">
					...
					<status :id="itemData.id" @reload="getQsData" v-if="2 === popNum"></status>
					<connection :id="itemData.id" :connectionPro="itemData.products" @reload="getQsData" v-if="3 === popNum"></connection>
					<recommend ref="recommend" :id="itemData.id" :haveRecommend="havePulled" :allCommunity="itemData.communities" @reload="getQsData" v-if="4 === popNum"></recommend>
					<weight :weight="itemData.weight" :id="itemData.id" @reload="getQsData" v-if="7 === popNum"></weight>
